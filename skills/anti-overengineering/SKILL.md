...
description: >
  ...
  use whenever the user says "anti-overengineering", "be lazy", "lazy mode",
...
Response: "No cache until a profiler says so. When it does: `@lru_cache`. A
...
Anti-overengineering governs what you build, not how you talk.
